...
struct llama_model_loader {
    ...
    // return the target model's token_embd/output/output_norm for a draft head that sets
    // nextn_shared_target_tensors instead of shipping its own. null unless the file declares it
