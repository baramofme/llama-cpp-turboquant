...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_PQ2_0         = 141, // except 1d tensors (group-128 Q2_0; matches published PQ2_0 ggufs)
        LLAMA_FTYPE_MOSTLY_PTQ1_0        = 143, // except 1d tensors (group-128 ternary; matches published PTQ1_0 ggufs)
